...
my_account = BankAccount(name, initial_balance) # create user account
...
while user_input != "exit":
  ...
  match user_input:
    case "print":
      print_account_details(my_account) # print out the user details
    case "deposit":
      get_user_deposit(my_account) # add money
    case "withdraw":
      get_user_withdraw(my_account) # remove money
